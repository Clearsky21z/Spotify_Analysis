...
The remainder of this paper is constructed as follows. @sec-data provides a sample of the downloaded dataset, @sec-res gives three plots comparing Valence, Duration, and Energy in the Music of JJ Lin, Joker Xue, and Leehom Wang and @sec-disc mentiones a brief discussion of the result.
